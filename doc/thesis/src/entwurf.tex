...
\begin{tikzpicture}
\begin{axis}[
title={Performance Improvements depending on different run lengths},
...
\addplot[
	...
	coordinates {
		(3,87.74)(4,82.74)(5,83.88)(6,86.91)(7,90.93)(8,95.54)
	};
\addplot[
	color=red,
	mark=square,
	...
	coordinates {
		(3,84.26)(4,80.52)(5,79.01)(6,78.99)(7,79.88)(8,81.34)
	};
\addplot[
	color=green,
	mark=square,
	...
	coordinates {
		(3,85.82)(4,82.59)(5,80.82)(6,80.06)(7,79.92)(8,80.17)
	};
	\legend{4 most sign. bits,3 most sign. bits,2 most sign. bits}
\end{axis}
\end{tikzpicture}
