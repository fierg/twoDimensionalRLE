...
class StringRLECorpus5BitTest {
    ...
    companion object {
        ...
        private const val encodeFolder = "data/encoded/rle/5bit"
        private const val decodeFolder = "data/decoded/rle/5bit"
    }
